...
urlpatterns = [
    path('pictures/<int:picture_id>/comments/', CommentView.as_view(), name='comment-list'),
    path('api/user/login/', UserLoginView.as_view(), name='user_login'),
    path('api/user/logout/', UserLogoutView.as_view(), name='user_logout'),
    path('api/gallery/search/', GallerySearchResultsView.as_view(), name='gallery_search_results'),
